...
export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a.75.75 0 01.75.75v.008a.75.75 0 01-1.5 0V19.5a.75.75 0 01.75-.75zM10.5 6a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0V6zM18.75 12a6.75 6.75 0 01-6.75 6.75v0a6.75 6.75 0 01-6.75-6.75v-3.75a6.75 6.75 0 0113.5 0v3.75z" />
    </svg>
);
